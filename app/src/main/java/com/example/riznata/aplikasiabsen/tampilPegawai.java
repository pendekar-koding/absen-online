...
public class tampilPegawai {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editTextName = (EditText) editTextName.findViewById();
        editTextDesg = (EditText) editTextId.findViewById();
        editTextSalary = (EditText) findViewById(R.id.editTextPass);
    ...
    private void showEmployee(String json){
        try {
            ...
            String sal = c.getString(konfigurasi.TAG_PASSWORD);
    ...
    private void updateEmployee(){
        ...
        class UpdateEmployee extends AsyncTask<Void,Void,String>{
            ...
            protected String doInBackground(Void... params) {
                ...
                hashMap.put(konfigurasi.KEY_EMP_PASSWORD,salary);
